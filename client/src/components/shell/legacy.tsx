...
export function Footer() { return <footer className="site-footer shell-footer"><div className="container footer-inner"><div className="footer-brand"><Link href="/" className="footer-logo"><img src={IMG.logoH} alt="El-Biyahe! — Come Curious"/></Link><p>Your field companion for discovering the many sides of Los Baños — events, places, flavors, and stories worth collecting.</p></div><nav className="footer-links" aria-label="Footer navigation"><div><b>Discover</b><Link href="/events">Events</Link><Link href="/explore">Explore</Link><Link href="/heritage-walk">Heritage Walk</Link><Link href="/delicacies">Delicacies</Link><Link href="/tours">Bus Tours</Link></div><div><b>Get around</b><Link href="/ride-guide">Ride Guide</Link><Link href="/parking">Parking</Link><Link href="/stay-eat">Stay &amp; Eat</Link></div><div><b>Your El-Biyahe!</b><Link href="/passport">Digital LB Passport</Link><Link href="/account">Profile</Link></div></nav><div className="footer-bottom"><span>© 2026 El-Biyahe! · Los Baños</span><span>Come Curious.</span></div></div></footer> }
