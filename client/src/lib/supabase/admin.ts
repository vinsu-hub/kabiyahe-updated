...
export async function adminCounts() {
  const tables = ["events", "tour_packages", "passport_locations", "passport_rewards", "tour_reservations", "profiles", "delicacies", "accommodations", "parking_spots", "destinations"] as const;
