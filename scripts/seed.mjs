...
const tours = [
  { slug: "makiling-explorer-tour", operator: "laguna-heritage-coaches", title: "Makiling Explorer Tour", tags: ["Nature", "Culture"],
    ...
    hero_image: "/tours/lake-town.jpg", reserve_url: "https://example.com/lagunaheritagecoaches/makiling-explorer",
  ...
  { slug: "heritage-science-journey", operator: "elbi-discovery-tours", title: "Heritage & Science Journey", tags: ["Culture", "Science"],
    ...
    hero_image: "/tours/heritage-church.jpg", reserve_url: "https://example.com/lagunadiscoverytours/heritage-science",
  ...
  { slug: "uplb-campus-flavors-tour", operator: "elbi-discovery-tours", title: "UPLB Campus & Flavors Tour", tags: ["Food", "Culture"],
    ...
    hero_image: "/tours/food-spread.jpg", reserve_url: "https://example.com/lagunadiscoverytours/campus-flavors",
  ...
  { slug: "makiling-nature-trek", operator: "laguna-heritage-coaches", title: "Makiling Nature Trek & Hot Springs", tags: ["Nature"],
    duration: "1 Day", price_per_seat: 1650, rating: 4.7, review_count: 21, featured: false, season_key: "sol-open",
    origin_pickup_points: ["Manila (Cubao)", "Calamba Crossing"], departure_schedule: "Saturdays & Sundays, 5:30 AM departure",
    seat_capacity: 30, seats_available: 14, includes: ["Air-conditioned coach", "Licensed nature guide", "Trail permits", "Packed lunch"],
    hero_image: "/tours/misty-mountains.jpg", reserve_url: "https://example.com/lagunaheritagecoaches/makiling-nature-trek",
    summary: "A nature-first day on Mt. Makiling's lower trails — the Mud Spring, the Botanic Gardens, and a soak at the Los Baños hot springs before the ride home.",
    stops: [
      { time_label: "7:00 AM", name: "Makiling Mud Spring", blurb: "Boardwalk trail to the bubbling sulfur spring." },
      { time_label: "9:30 AM", name: "Makiling Botanic Gardens", blurb: "Guided walk through the UPLB living plant museum." },
      { time_label: "12:00 NN", name: "Lunch — trailside", blurb: "Packed lunch at a shaded viewpoint." },
      { time_label: "2:00 PM", name: "Los Baños Hot Springs", blurb: "Warm mineral soak at a resort pool — bring a change of clothes." },
      { time_label: "4:00 PM", name: "Tadlac Lake View Deck", blurb: "Golden-hour stop before the return trip." },
    ],
    reviews: [
      { author_name: "Rina D.", rating: 5, body: "The mud spring trail was a highlight. Guide kept a good pace." },
      { author_name: "Paolo S.", rating: 4, body: "Loved the hot springs at the end. Long day but worth it." },
    ] },
  { slug: "seven-lakes-circuit", operator: "elbi-discovery-tours", title: "Seven Lakes of San Pablo Circuit", tags: ["Nature", "Science"],
    duration: "1 Day", price_per_seat: 1750, rating: 4.6, review_count: 15, featured: false, season_key: null,
    origin_pickup_points: ["Manila (Ortigas)", "Calamba Crossing"], departure_schedule: "First & third Saturdays, 6:00 AM departure",
    seat_capacity: 32, seats_available: 19, includes: ["Air-conditioned coach", "Licensed guide", "Pandin Lake raft & lunch", "Crater-lake briefing"],
    hero_image: "/tours/lake-town.jpg", reserve_url: "https://example.com/lagunadiscoverytours/seven-lakes",
    summary: "A circuit of San Pablo's volcanic crater lakes — Sampaloc, Pandin, and Bunot — with a raft lunch on Pandin and a short talk on how the maars formed.",
    stops: [
      { time_label: "8:30 AM", name: "Sampaloc Lake", blurb: "The largest of the seven, ringed by a lakeside walk." },
      { time_label: "10:30 AM", name: "Pandin Lake", blurb: "Bamboo-raft crossing with a cooked lunch on the water." },
      { time_label: "1:30 PM", name: "Bunot Lake", blurb: "A quieter maar with fish pens and a farming community." },
      { time_label: "3:00 PM", name: "San Pablo Cathedral", blurb: "A stop in the poblacion before the ride home." },
    ],
    reviews: [{ author_name: "Meg C.", rating: 5, body: "Pandin Lake raft lunch was unforgettable. Very relaxed day." }] },
  { slug: "los-banos-food-crawl", operator: "elbi-discovery-tours", title: "Los Baños Food Crawl", tags: ["Food"],
    duration: "Half Day", price_per_seat: 950, rating: 4.5, review_count: 27, featured: false, season_key: null,
    origin_pickup_points: ["Calamba Crossing", "Los Baños Grove"], departure_schedule: "Fridays & Saturdays, 2:00 PM departure",
    seat_capacity: 24, seats_available: 6, includes: ["Air-conditioned coach", "Local food guide", "Tastings at 4 stops"],
    hero_image: "/tours/food-spread-alt.jpg", reserve_url: "https://example.com/lagunadiscoverytours/food-crawl",
    summary: "An afternoon of Los Baños classics — the public market, buko pie, Mer-Nel's chocolate cake, and fresh dairy from the UPLB institute.",
    stops: [
      { time_label: "2:30 PM", name: "Los Baños Public Market", blurb: "Fruit stalls, kakanin, and a taste of the day's catch." },
      { time_label: "3:15 PM", name: "Buko Pie House", blurb: "Tasting stop — the Los Baños classic." },
      { time_label: "4:00 PM", name: "Mer-Nel's Cake", blurb: "A slice of the town's famous chocolate cake." },
      { time_label: "4:45 PM", name: "DTRI Dairy", blurb: "Fresh milk, kesong puti, and dairy ice cream from the UPLB institute." },
    ],
    reviews: [
      { author_name: "Trish A.", rating: 5, body: "Came hungry, left very full. The dairy stop was a surprise favourite." },
      { author_name: "Ben O.", rating: 4, body: "Great value for a half day. Bring extra cash for pasalubong." },
    ] },
  { slug: "rizal-heritage-route", operator: "laguna-heritage-coaches", title: "Rizal Heritage Route: Calamba & Los Baños", tags: ["Culture"],
    duration: "1 Day", price_per_seat: 1399, rating: 4.6, review_count: 12, featured: false, season_key: "banada",
    origin_pickup_points: ["Manila (Cubao)", "Sta. Rosa"], departure_schedule: "Second & fourth Saturdays, 7:00 AM departure",
    seat_capacity: 36, seats_available: 22, includes: ["Air-conditioned coach", "Licensed heritage guide", "Rizal Shrine entrance", "Lunch"],
    hero_image: "/tours/church-golden.jpg", reserve_url: "https://example.com/lagunaheritagecoaches/rizal-heritage-route",
    summary: "Following José Rizal from his Calamba birthplace to the Los Baños poblacion — the reconstructed Rizal house, the town churches, and a campus heritage stop.",
    stops: [
      { time_label: "8:30 AM", name: "Rizal Shrine", blurb: "The reconstructed Rizal family home in Calamba." },
      { time_label: "10:00 AM", name: "St. John the Baptist Church", blurb: "Where Rizal was baptised, a short walk from the shrine." },
      { time_label: "12:00 NN", name: "Lunch — Calamba", blurb: "Set lunch before crossing to Los Baños." },
      { time_label: "1:30 PM", name: "San Antonio de Padua Parish", blurb: "Start of the Los Baños heritage core walk." },
      { time_label: "3:00 PM", name: "Baker Hall & Fertility Tree", blurb: "Heritage architecture and campus lore at UPLB." },
    ],
    reviews: [{ author_name: "Diego M.", rating: 5, body: "A thoughtful route. The guide connected the two towns' stories really well." }] },
];
...
const STOP_COORDS = {
  ...
  "Makiling Mud Spring": [14.1350, 121.2020], "Lunch — trailside": [14.1500, 121.2300],
  "Los Baños Hot Springs": [14.1690, 121.2440], "Sampaloc Lake": [14.0700, 121.3250],
  "Pandin Lake": [14.1170, 121.3900], "Bunot Lake": [14.0850, 121.3100],
  "San Pablo Cathedral": [14.0690, 121.3260], "Los Baños Public Market": [14.1700, 121.2410],
  "Mer-Nel's Cake": [14.1690, 121.2400], "DTRI Dairy": [14.1650, 121.2380],
  "Rizal Shrine": [14.2110, 121.1650], "St. John the Baptist Church": [14.2120, 121.1660],
  "Lunch — Calamba": [14.2100, 121.1640],
};
