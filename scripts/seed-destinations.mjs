...
const raw = [
  ...
  { name: "Los Baños Hot Springs", place: "Los Baños, Laguna", image: IMG.hero, gallery: [IMG.hero, IMG.lake, IMG.falls], type: "Relaxation", icon: "Sparkles", description: "The public and resort hot-spring pools that give Los Baños its name — warm, mineral-rich water fed by Mt. Makiling, in bathing complexes around the poblacion and Pansol edge.", rating: "4.7", reviews: "361", tags: ["Relaxation", "Family Friendly", "Romantic"], price: 3 },
